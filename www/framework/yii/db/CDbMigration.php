 ...
 *
 * CDbMigration is designed to be used together with the "yiic.bat migrate" command.
 *
 ...
 * logic. The "yiic.bat migrate" command manages all available migrations in an application.
 *
