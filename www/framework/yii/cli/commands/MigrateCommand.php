...
class MigrateCommand extends CConsoleCommand
{
	...
	public function getHelp()
	{
		return <<<EOD
USAGE
  yiic.bat migrate [action] [parameter]
...
EXAMPLES
 * yiic.bat migrate
   Applies ALL new migrations. This is equivalent to 'yiic.bat migrate up'.

 * yiic.bat migrate create create_user_table
   Creates a new migration named 'create_user_table'.

 * yiic.bat migrate up 3
   Applies the next 3 new migrations.

 * yiic.bat migrate down
   Reverts the last applied migration.

 * yiic.bat migrate down 3
   Reverts the last 3 applied migrations.

 * yiic.bat migrate to 101129_185401
   Migrates up or down to version 101129_185401.

 * yiic.bat migrate to 1392447720
 ...
 * yiic.bat migrate to "2014-02-15 13:00:50"
